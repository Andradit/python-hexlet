"""Вам необходимо реализовать функцию duplicate(), которая должна принимать в
качестве аргумента список и удваивать этот список "по месту".Вам нужно будет
изменять исходный объект списка. Помним, список передается по ссылке.
